...
const POSHIST = [
  { posId: 'p1', instId: 'BTC-USDT-SWAP', posSide: 'long',  openAvgPx: '60000', closeAvgPx: '62000', closeTotalPos: '5',  realizedPnl: '100', fee: '-0.6', fundingFee: '-0.1', lever: '10', cTime: '1718600000000', uTime: '1718610000000' },
  { posId: 'p2', instId: 'ETH-USDT-SWAP', posSide: 'short', openAvgPx: '3000',  closeAvgPx: '2900',  closeTotalPos: '10', realizedPnl: '100', fee: '-0.3', fundingFee: '0',   lever: '5',  cTime: '1718620000000', uTime: '1718630000000' },
...
test('OKX fetchTrades normaliseert positions-history correct', async ({ page }) => {
  ...
  expect(parseFloat(btc.pnl)).toBeCloseTo(99.3, 2);                 // 100 − 0.6 − 0.1
  expect(parseFloat(btc.fees)).toBeCloseTo(0.7, 4);
  ...
  expect(parseFloat(eth.pnl)).toBeCloseTo(99.7, 2);                 // 100 − 0.3
