...
const SPECS = [
  ...
  'exchange-sync', 'exchange-sync2', 'balance-sync', 'auto-sync', 'valuta', 'okx-positie', 'okx-levensloop', 'hyperliquid-levensloop', 'blofin-levensloop', 'scenario-levensloop', 'gesynct-vergrendeld', 'execution-stappen', 'koppelingen-menu', 'account-remove', 'robustness', 'multi-tab', 'tj-migrate', 'pnl-pct', 'unit-toggle', 'possize',
