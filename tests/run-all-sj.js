...
const SPECS = [
  ...
  'exchange-sync', 'exchange-sync2', 'balance-sync', 'auto-sync', 'valuta', 'okx-positie', 'okx-levensloop', 'okx-subtype', 'okx-partial', 'partial-alle-exchanges', 'okx-partial-herstel', 'hyperliquid-levensloop', 'hl-open-tijd', 'blofin-levensloop', 'kraken-levensloop', 'kraken-afronding', 'scenario-levensloop', 'gesynct-vergrendeld', 'execution-stappen', 'koppelingen-menu', 'account-remove', 'robustness', 'multi-tab', 'tj-migrate', 'tj-overzetten', 'pnl-pct', 'unit-toggle', 'tp-overzicht', 'afgeleide-stappen', 'afgeleide-scenarios', 'handmatig-formulier', 'handmatig-scenarios', 'handmatig-statistieken', 'landing', 'tradingplan-v2', 'plan-koppeling', 'plan-tendencies', 'plan-doorloop', 'plan-playbook', 'export-overzicht', 'import-keuze', 'export-import-rondje', 'diagnose', 'possize',
