...
const SPECS = [
  ...
  'exchange-sync', 'exchange-sync2', 'balance-sync', 'auto-sync', 'valuta', 'okx-positie', 'execution-stappen', 'account-remove', 'robustness', 'multi-tab', 'tj-migrate', 'pnl-pct', 'unit-toggle', 'possize',
