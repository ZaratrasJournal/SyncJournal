...
2. **Pull state from these sources (in order):**
   - Plan files referenced this session (check `C:\Users\Denny\.claude\plans\` if a plan was mentioned).
   ...
   - Memory files written or updated (`C:\Users\Denny\.claude\projects\c--Users-Denny-Documents-Tradejournal\memory\`).
