 ...
 *    3. Diagnostic histograms in _v18Debug:
...
async function handleKraken(action, { apiKey, apiSecret, startTime }) {
  ...
  // v18: SIZE-DECREASE check toegevoegd. Naast positionChange-label check
  // ook expliciet of |newPosition| < |oldPosition|. Dit sluit scaling-in
  // false-positives uit: events waar oldPosition en newPosition allebei
  // negatief (short) of positief (long) zijn met newPosition GROTER in
  // absolute waarde = increase, NIET decrease. Equivalent van TradesViz's
  // flat-position split.
